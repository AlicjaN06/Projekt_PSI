...
#Dla Dirty Dancing----
# Wczytanie danych tekstowych Napisy z filmu Dirty Dancing
# Odczytanie lokalnego pliku .txt
text <- readLines("dirtydancing.txt", encoding="UTF-8")
...
# Analiza sentymentu Dirty Dancing ----
...
ggplot(word_counts, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Dirty Dancing (Loughran)") +
...
ggplot(word_counts_nrc2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Dirty Dancing (NRC)")
...
ggplot(word_counts_bing2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Dirty Dancing (Bing)") +
...
ggplot(word_counts_afinn3, aes(x=word2, y=n, fill=value)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Dirty Dancing (AFINN)")

#Dla Tytanika----
text <- readLines("titanic.txt", encoding="UTF-8")
...
# Analiza sentymentu dla tytanika ----
...
ggplot(word_counts, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu Dla Tytanika (Loughran)") +
  scale_fill_manual(values = c("firebrick", "darkolivegreen4"))
...
ggplot(word_counts_nrc2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu Dla Tytanika (NRC)")
...
ggplot(word_counts_bing2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu Dla Tytanika (Bing)") +
  scale_fill_manual(values = c("dodgerblue4", "goldenrod1"))
...
ggplot(word_counts_afinn3, aes(x=word2, y=n, fill=value)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu Dla Tytanika (AFINN)")


#Dla Obsession----
text <- readLines("obsession.txt", encoding="UTF-8")
...
# Analiza sentymentu dla Obsession ----
...
ggplot(word_counts, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Obsession (Loughran)") +
  scale_fill_manual(values = c("firebrick", "darkolivegreen4"))
...
ggplot(word_counts_nrc2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Obsession (NRC)")
...
ggplot(word_counts_bing2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Obsession (Bing)") +
  scale_fill_manual(values = c("dodgerblue4", "goldenrod1"))
...
ggplot(word_counts_afinn3, aes(x=word2, y=n, fill=value)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Obsession (AFINN)")

#Dla Resident Evil----
text <- readLines("residentevil.txt", encoding="UTF-8")
...
# Analiza sentymentu dla Resident Evil ----
...
ggplot(word_counts, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Resident Evil (Loughran)") +
  scale_fill_manual(values = c("firebrick", "darkolivegreen4"))
...
ggplot(word_counts_nrc2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Resident Evil (NRC)")
...
ggplot(word_counts_bing2, aes(x=word2, y=n, fill=sentiment)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Resident Evil (Bing)") +
  scale_fill_manual(values = c("dodgerblue4", "goldenrod1"))
...
ggplot(word_counts_afinn3, aes(x=word2, y=n, fill=value)) + 
  ...
  labs(x = "Słowa", y = "Liczba") +
  theme_gdocs() + 
  ggtitle("Liczba słów wg sentymentu dla Resident Evil (AFINN)")